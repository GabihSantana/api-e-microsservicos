...
/**
 * 
 * @RestControllerAdvice intercepta exceções lançadas em qualquer parte daaplicação e retorna uma resposta adequada para o cliente.
 * 
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Trata exceções genéricas que não foram capturadas pelos handlers anteriores : Fallback
     */
